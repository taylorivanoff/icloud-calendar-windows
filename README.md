# iCloud Calendar Windows

This project offers a native Windows application via Electron for accessing iCloud calendar and other content available on [icloud.com](https://www.icloud.com/). 
Unlike Apple's official iCloud for Windows, which focuses on managing iCloud Drive, Photos, and Bookmarks, this client specifically targets calendar and always defaults to iCloud Calendar.
...
- **Right-Click Menu**: Right-click the tray icon to access quick options:
  - **Show iCloud Calendar**: Opens the main window.
  - **Quit**: Fully exits the application.
- **Start with Windows**: Once signed in, the app will start automatically with Windows.

## Setup

1. **Releases**: Download the latest release of the application.
2. **Sign in to your iCloud account**: Upon launching the application, sign in to your iCloud account to access your calendar.
3. **Enjoy!**: Once signed in, you can seamlessly view and manage your iCloud calendar within the Windows environment.
