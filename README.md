...
iCloud Calendar desktop app for Windows. Loads [icloud.com/calendar](https://www.icloud.com/calendar) in a native **Tauri / WebView2** shell.
...
- **Deep link** — `icloud-calendar://` protocol handler
